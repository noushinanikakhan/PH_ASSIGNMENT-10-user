                    ...
                    <div className="lg:w-1/2 text-center lg:text-left">
                        <div className="mb-8">
                            ...
                            <p className="text-lg text-gray-600 leading-relaxed">
                                Become part of our food-sharing community and help reduce waste while feeding your neighbors. 
                                Together, we can create a sustainable future where no good food goes to waste.
                            </p>
                        </div>
